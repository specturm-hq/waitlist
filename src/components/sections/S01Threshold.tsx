...
export default function S01Threshold() {
    ...
    return (
        <section
            className="relative min-h-screen w-full flex flex-col items-center justify-center z-20 overflow-visible"
        >
            {/* ── Ambient Background ── */}
            ...
            {/* ── Content ── */}
            <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-5xl pt-24 md:pt-28 pb-12">
                {/* Overline */}
                <motion.div
